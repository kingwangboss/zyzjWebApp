                ...
                <div class="detail-bottom">
                    ...
                    <div class="bottom-cell" v-for="(itemCell,indexCell) in item.PlanDetails" :key="itemCell">
                        <div v-if="indexCell != 0">
                            <div class="cell-top">
                                <span style="margin-left:5px;margin-top:5px;font-size:13px;">{{itemCell.split('|')[0]}}</span>
                                <span style="margin-left:5px;margin-top:5px;font-size:13px; color:#CD0C16;">预</span>
                                <span style="margin-left:5px;margin-top:5px;font-size:13px;">{{itemCell.split('|')[1]}}</span>
                            </div>
